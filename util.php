...
{
    /*
    chaves do array: tabela( ou apelido),campo,valor,operador,logSemAspas 
        ...
        foreach($aTels as $tel){
            if($tel <> ''){
                ...
                if(strlen($telPuro) > 10 or (strlen($telPuro) == 10 and substr($telPuro,2,1) == '9')  ){
                    ...
                    $retorno = util_incr_valor($retorno," <a href='https://wa.me/{$telWz}'><i class='bi bi-whatsapp'></i></a>",'');       
                }
...
function inserirArrayCond($aFiltro,$tabela,$campo,$valor,$operador='=',$logSemAspas=false,$logAceitaBranco=false)
{
